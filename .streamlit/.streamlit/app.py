...
# ----------------- القائمة الجانبية (Navigation Bar - 5 أقسام) -----------------
with st.sidebar:
    ...
    selected_tab = option_menu(
        menu_title="أقسام المنصة",
        options=[
            "صديقي الذكي (AI Companion)", 
            "قسم هندسة الإلكترونيك والاتصالات", 
            "موسوعة قطع الـ PC والإلكترونيات", 
            "محلل الدوائر والمخططات بالذكاء الاصطناعي", 
            "مساعد الإنتاجية والأفكار الفردية"
        ],
        icons=["robot", "cpu", "gpu", "camera", "lightbulb"],
        menu_icon="cast",
        default_index=0,
        styles={
            "container": {"background-color": "transparent"},
            "icon": {"color": "#38bdf8", "font-size": "18px"},
            "nav-link": {"font-size": "14px", "text-align": "right", "margin": "5px 0", "color": "#f1f5f9"},
            "nav-link-selected": {"background-color": "#0284c7"},
        }
    )
    st.markdown("---")
    st.info("💡 **الحالة:** الأنظمة تعمل بكفاءة ومرتبة بالكامل.")

# =========================================================================
# القسم الأول: صديقي الذكي (AI Companion مع شخصية Emoji تفاعلية ومحادثة)
# =========================================================================
if selected_tab == "صديقي الذكي (AI Companion)":
    ...
    # اختيار حالة الأفاتار بناءً على التفاعل
    ...
    # محاكاة واجهة الدردشة (Chat Box)
    st.markdown("### 💬 نافذة المحادثة المباشرة")
    
    # رسالة ترحيبية افتراضية من الصديق
    st.markdown("""
        <div style="background: rgba(30, 41, 59, 0.8); padding: 12px 18px; border-radius: 12px; margin-bottom: 10px; border-left: 4px solid #38bdf8;">
            <b>فوزي 🤖:</b> هلا بيوسف! شلونك اليوم؟ تدري بيا موجود دايماً حتى لو ضايج أو عندك شي بقلبك تحب تحكيه، أو حتى اذا تريد ندردش بشغلات تخص الكلية والهندسة. اشر بس! 😄
        </div>
    """, unsafe_allow_html=True)
...
# =========================================================================
# القسم الثاني: قسم هندسة الإلكترونيك والاتصالات (الدراسي)
# =========================================================================
elif selected_tab == "قسم هندسة الإلكترونيك والاتصالات":
    ...
    with col_s2:
        ...
        st.markdown("""
        - **المفهوم الأساسي:** يتم استخدام النظريات الهندسية الحديثة لضمان نقل البيانات بأعلى كفاءة وأقل نسبة ضوضاء (Noise).
...
# =========================================================================
# القسم الثالث: موسوعة قطع الـ PC والقطع الإلكترونية مع الأسعار
# =========================================================================
elif selected_tab == "موسوعة قطع الـ PC والقطع الإلكترونية":
...
# =========================================================================
# القسم الرابع: محلل الدوائر والمخططات بالذكاء الاصطناعي
# =========================================================================
elif selected_tab == "محلل الدوائر والمخططات بالذكاء الاصطناعي":
